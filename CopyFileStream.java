...
public class CopyFileStream {
    ...
    public static InputStream getFileInputStream(String fileSource) throws FileNotFoundException {
        if(inputStream == null)
            synchronized (sync) {
                if(inputStream == null) return new FileInputStream(fileSource);
            }
        return inputStream;
    }

    public static OutputStream getFileOutputStream(String dislocationFile) throws FileNotFoundException {
